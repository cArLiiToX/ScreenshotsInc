...
class OrdersStore extends UTIL
{
    ...
    public function getOrderDetails($return = 0)
    {
        ...
        if ($this->storeApiLogin == true) {
            ...
            try {
                $filters = array('orderIncrementId' => $orderId, 'store' => $this->getDefaultStoreId(), 'color' => $this->getStoreAttributes("xe_color"), 'size' => $this->getStoreAttributes("xe_size"));
...
//for name and number folder scan
    ...
    public function downloadOrderDetail()
    {
        ...
        $this->_request['orderIncrementId'] = $orderId;
