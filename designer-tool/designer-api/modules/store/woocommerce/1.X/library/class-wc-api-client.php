...
class WC_API_Client
{
     ...
     * @return mixed|json string
     */
    public function get_products_attribute()
    {
        return $this->_make_api_call('products/attributes');
    }
     ...
     * @return mixed|json string
     */
    public function get_products_attribute_by_id($attribute_id)
    {
        return $this->_make_api_call('products/attributes/' . $attribute_id);
    }
    ...
    {
        return $this->_make_api_call('products', array(), 'POST', $data);
    }
    /**
     * edit Product
     * @param  json  $params
     * @return mixed|json string
     */
    public function edit_product($product_id, $data = array())
    {
        return $this->_make_api_call('products/' . $product_id, array(), 'POST', $data);
    }
     ...
     * @return mixed|json string
     */
    private function _make_api_call($endpoint, $params = array(), $method = 'GET', $body = array())
    {
        $ch = curl_init();
