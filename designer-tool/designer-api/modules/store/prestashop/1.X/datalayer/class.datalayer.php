...
class Datalayer
{
    ...
    public function addProductToCart($data = [])
    {
        ...
        if ($cart->id) {
            ...
            $url = $context->link->getPageLink($order_process, true);
            $msg['status'] = "success";
            $msg['url'] = $url;
            return $msg;
        } else {
    ...
    {
        $path = XEPATH . "xetool/install/prestashop/module_list.json"; //get mdule list
    ...
    public function addProduct()
    {
        ...
        if (empty($row[0]['nos'])) {
            ...
            //product image add
            $url[] = PS_SHOP_PATH . "xetool/install/prestashop/wizard/images/install_image/configurable.png";
    ...
    public function getProductInfo($data)
    {
        ...
        foreach ($combinations as $v) {
            if ($v['id_product_attribute'] == $configId) {
                ...
                if (($v['is_color_group'] == 1) && ($v['group_name'] == $data['coloe'])) {
