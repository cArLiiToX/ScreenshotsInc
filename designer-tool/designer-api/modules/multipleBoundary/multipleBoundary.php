...
class MultipleBoundary extends UTIL
{
     ...
     *
     */
    public function saveMultipleBoundary($pid, $MultiBoundData, $unitArr)
    {
        ...
        try {
            ...
            foreach ($maskDataAr as $key => $side) {
                ...
                $newMaskQry = "INSERT INTO " . TABLE_PREFIX . "multiple_boundary(name, svg_data, thumb_image, mask_height, mask_width, mask_unit) VALUES ('$name', '" . $svgdata . "', '$maskImage', '" . $maskheight . "', '" . $maskwidth . "', $unitArr[$key])";
                ...
                foreach ($side['child_masks'] as $childMask) {
                    $newChildQry = "INSERT INTO " . TABLE_PREFIX . "multiple_boundary_child(parent_mask_id, name) VALUES('" . $parentMaskId . "', '" . addslashes($childMask['boundary_name']) . "')";
                    $newChildQry .=
                ...
                foreach ($childArr as $key => $child) {
                    ...
                    $relQry = "INSERT INTO " . TABLE_PREFIX . "multiple_boundary_settings(boundary_rel_id, restrict_design,mask_height,mask_width) VALUES ('" . $newId . "', '" . $side['child_masks'][$key]['restrict_design'] . "', '" . $side['child_masks'][$key]['actual_height'] . "', '" . $side['child_masks'][$key]['actual_width'] . "')";
        ...
        try {
            ...
            foreach ($maskSVG as $side) {
                ...
                foreach ($childMasks as $key => $child) {
                    ...
                    $childMaskDet[$key]['actual_width'] = $maskSettings[0]['mask_width'];
                    $childMaskDet[$key]['actual_height'] = $maskSettings[0]['mask_height'];
                ...
                $childMaskData['scaleRatio_unit'] = $childMasks[0]['mask_unit'];
