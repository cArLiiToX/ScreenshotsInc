...
class Saverobot extends \Magento\Config\Block\System\Config\Form\Field
{
    protected $_saveButtonLabel = 'Save robot.txt';
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/saverobot.phtml');
        }
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url'     => $this->_urlBuilder->getUrl('seo/system_config_robot/save'),
            ]
        );
