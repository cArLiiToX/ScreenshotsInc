...
if(jscolor.preloading){jscolor.preload();}},getDir:function(){if(!jscolor.dir){var detected=jscolor.detectDir();detected=detected.replace('/js','/images');jscolor.dir=detected!==false?detected:'jscolor/';}
