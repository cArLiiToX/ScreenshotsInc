...
class CartsStore extends UTIL
{
    ...
    public function addToCart()
    {
        ...
        if ($this->storeApiLogin == true) {
            ...
            if (isset($this->_request['customerId'])) {
                $customerId = intval($this->_request['customerId']);
            }
            $action = 'add';
    ...
    /**
     *
     *date created 26-12-2016(dd-mm-yy)
     *date modified (dd-mm-yy)
    ...
    public function getTotalCartItem()
    {
        ...
        if ($this->storeApiLogin == true) {
            ...
            try {
                ...
                $result = $this->proxy->call($key, 'cedapi_cart.getTotalCartItem', $param);
