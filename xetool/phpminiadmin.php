...
#show full dump if just one field
                        $v = substr($v, 0, 16);
                        $pf = '...';
                    }
...
<br><label for ="rmb"><input type="checkbox" name="rmb" id="rmb" value="1" > Remember in cookies for 30 days</label>
</div>
<center>
...
{$x;return setcookie($n, $v, $e, $x, $x, !!$x, !$x);}
        ...
        while ($i--) {
            if ($ochar) {
                ...
                if ($ochar == ';') {
                    ...
                    $is_cmt = 0;if ($ochar == '/*' && substr($str, $opos, 3) != '/*!') {
                        $is_cmt = 1;
                    }
